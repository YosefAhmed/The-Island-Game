...
public class IsometricCharacterRenderer : MonoBehaviour
{
    ...
    public static readonly string[] staticDirections = { "Idle North", "Idle NW", "Idle West", "Idle SW", "Idle South", "Idle SE", "Idle East", "Idle NE" };
    public static readonly string[] runDirections = { "Walk North", "Walk NW", "Walk West", "Walk SW", "Walk South", "Walk SE", "Walk East", "Walk NE" };
